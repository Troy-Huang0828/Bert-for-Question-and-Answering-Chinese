...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, help='dataset/public', default='dataset/public.json')
    parser.add_argument('--prediction_path', type=str, help='output_save/64.8/predictions.json', default='output/predictions.json')
    parser.add_argument('--output_path', type=str, help='save.json', default='save.json')
...
def count_score(data_path, prediction_path, output_path):
